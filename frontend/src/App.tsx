...
//import {OrderHistor from './components/OrderHistory';
          ...
          <Box sx={{ display: 'flex' }}>
            ...
            <Main open={open}>
              ...
              <Routes>
                ...
                { role === "intendant" && <Route path='/'element={<HomePage/> }/>}
                { role === "intendant" && <Route path='/order' element={<OrderPage />}/> }
                { role === "intendant" && <Route path='/orderhistory' element={<OrderHistory />}/> }
